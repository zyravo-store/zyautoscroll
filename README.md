...
| Item | Value |
| --- | --- |
| Version | Version 1.0.0 (260727) |
| Release notes and assets | [GitHub Release](https://github.com/zyravo-store/zyautoscroll/releases/tag/v1.0.0) |
...
- [Download the verified Release assets](https://github.com/zyravo-store/zyautoscroll/releases/tag/v1.0.0)
...
- Windows ZIP and Linux TAR.GZ files are browser-extension bundles, not native
...
| 项目 | 内容 |
| --- | --- |
| 版本 | Version 1.0.0 (260727) |
| 更新说明与安装包 | [GitHub Release](https://github.com/zyravo-store/zyautoscroll/releases/tag/v1.0.0) |
...
- [下载已验证的 Release 安装包](https://github.com/zyravo-store/zyautoscroll/releases/tag/v1.0.0)
- [简体中文安装指南](https://github.com/zyravo-store/zyautoscroll/wiki/ZH-CN-Installation)
...
- Windows ZIP 与 Linux TAR.GZ 是浏览器扩展合集，不是 EXE、MSI、AppImage、DEB
...
- [使用文档](https://github.com/zyravo-store/zyautoscroll/wiki)
- [官方网站](https://zyautoscroll.zyravo.store)
